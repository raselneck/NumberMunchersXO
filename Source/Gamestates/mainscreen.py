...
class MainScreen:
    ...
    def start(self):
        ...
        self.gameButton.baseColour = self.instructionsButton.baseColour = self.highScoresButton.baseColour = self.aboutButton.baseColour = (
        0, 0, 0)
        self.gameButton.hoverColour = self.instructionsButton.hoverColour = self.highScoresButton.hoverColour = self.aboutButton.hoverColour = (
        255, 255, 255)
        self.gameButton.clickColour = self.instructionsButton.clickColour = self.highScoresButton.clickColour = self.aboutButton.clickColour = (
        128, 128, 128)
