...
class MainScreen:
    ...
    def start(self):
        ...
        self.gameButton.rect = pygame.Rect((self.screenInfo.current_w/2) - (width/2), (self.screenInfo.current_h/2) - 60 - (height/2), width, height)
        self.gameButton.text = "Start Game"
        
        # Instructions button
        self.instructionsButton = self.uiContainer.add_button()
        self.instructionsButton.rect = pygame.Rect((self.screenInfo.current_w/2) - (width/2), (self.screenInfo.current_h/2) - 30 - (height/2), width, height)
        self.instructionsButton.text = "Instructions"
        
        # High Scores button
        self.highScoresButton = self.uiContainer.add_button()
        self.highScoresButton.rect = pygame.Rect((self.screenInfo.current_w/2) - (width/2), (self.screenInfo.current_h/2) - (height/2), width, height)
        self.highScoresButton.text = "High Scores"
        
        # About button
        # High Scores button
        self.aboutButton = self.uiContainer.add_button()
        self.aboutButton.rect = pygame.Rect((self.screenInfo.current_w/2) - (width/2), (self.screenInfo.current_h/2) + 30 - (height/2), width, height)
